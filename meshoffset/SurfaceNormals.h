...
public:
    ...
    //肖和
    static void vertex_shape_centroid(SurfaceMesh& mesh);

    static Normal vertex_shape_centroid(const SurfaceMesh& mesh, Vertex v);


    //高珊
    static void vertex_angle_perimeter(SurfaceMesh& mesh);

    static Normal vertex_angle_perimeter(const SurfaceMesh& mesh, Vertex v);


    //本文
    static void shape_angle_centroid(SurfaceMesh& mesh);

    static Normal shape_angle_centroid(const SurfaceMesh& mesh, Vertex v);


    //高健
    static void vertex_angle_centroid(SurfaceMesh& mesh);

    static Normal vertex_angle_centroid(const SurfaceMesh& mesh, Vertex v);
